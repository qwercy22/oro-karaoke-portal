...
const ADMIN_PASSWORD = "Soundy1234";
const MAX_QUEUE = 10;
...
export default function KaraokePortal() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "linear-gradient(160deg, #000d1a 0%, #001a2e 30%, #002a3a 60%, #001520 100%)",
      ...
      <style>{`
        ...
        @keyframes flicker {
          0%, 100% { opacity: 1; text-shadow: 0 0 20px #00e5ff, 0 0 40px #00e5ff, 0 0 80px #00e5ff; }
          50% { opacity: 0.85; text-shadow: 0 0 10px #00e5ff, 0 0 30px #00e5ff; }
        }
        @keyframes wave {
        ...
        .submit-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 30px rgba(0,180,216,0.4); }
        ...
        .queue-row:hover { background: rgba(0,229,255,0.07); }
        .tab-btn {
      ...
      {/* Ocean wave orbs */}
      {[
        { top: "-20%", left: "-10%", color: "rgba(0,119,182,0.25)", animation: "wave 8s ease-in-out infinite" },
        { bottom: "-20%", right: "-10%", color: "rgba(0,180,216,0.2)", animation: "wave 10s ease-in-out infinite reverse" },
        { top: "30%", right: "-15%", color: "rgba(0,229,255,0.1)", animation: "wave 12s ease-in-out infinite" },
        { top: "60%", left: "-15%", color: "rgba(3,4,94,0.4)", animation: "wave 9s ease-in-out infinite reverse" },
      ].map((orb, i) => (
        <div key={i} style={{
      ...
      {toast && (
        <div style={{
          ...
          background: toast.type === "success" ? "rgba(0,229,255,0.15)" : "rgba(255,80,80,0.15)",
          border: `1px solid ${toast.type === "success" ? "rgba(0,229,255,0.4)" : "rgba(255,80,80,0.4)"}`,
          backdropFilter: "blur(12px)", borderRadius: 6, padding: "12px 24px",
          color: "#fff", fontFamily: "'Crimson Text', serif", fontSize: 16,
          zIndex: 300, whiteSpace: "nowrap", animation: "toast-in 0.3s ease",
        }}>{toast.msg}</div>
      )}
      ...
      {showAdminLogin && (
        <div style={{
          ...
          <div style={{
            background: "#000d1a", border: "1px solid rgba(0,229,255,0.3)",
            borderRadius: 8, padding: 32, width: 320, animation: "slide-up 0.3s ease",
            ...
            <input className="neon-input" type="password" placeholder="Password..."
              value={adminPassword}
      ...
      {removeConfirm && (
        <div style={{
          ...
          <div style={{
            background: "#000d1a", border: "1px solid rgba(255,80,80,0.4)",
      ...
      <div style={{ width: "100%", maxWidth: view === "admin" ? 620 : 480, position: "relative", zIndex: 10 }}>
        ...
        {/* Tabs */}
        <div style={{
          display: "flex", background: "rgba(0,229,255,0.03)",
          border: "1px solid rgba(0,229,255,0.08)", borderRadius: 6,
          ...
          {["portal", "admin"].map(v => (
            <button key={v} className="tab-btn"
              ...
              style={{
                ...
                background: view === v ? "rgba(0,229,255,0.15)" : "none",
          ...
          <div style={{
            ...
            {submitted ? (
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                ...
                <h2 style={{ fontFamily: "'Playfair Display', serif", color: "#00e5ff", fontSize: 28, margin: "0 0 8px" }}>
                  You're on the list!
                </h2>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <div style={{
                  ...
                  background: spotsLeft <= 3 ? "rgba(255,100,0,0.1)" : "rgba(0,229,255,0.04)",
                  border: `1px solid ${spotsLeft <= 3 ? "rgba(255,100,0,0.3)" : "rgba(0,229,255,0.15)"}`,
                  ...
                  <span style={{
                    ...
                    color: spotsLeft <= 3 ? "#ff6600" : "#00e5ff",
                  }}>
        ...
        {view === "admin" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { label: "In Queue", value: waitingQueue.length, color: "#00e5ff" },
            ...
            {performingEntry && (
              <div style={{
                ...
                <div>
                  <div style={{ color: "#00e5ff", fontFamily: "'Playfair Display', serif", fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 4 }}>
                    🎤 Now Performing
                  </div>
                  <div style={{ color: "#fff", fontFamily: "'Playfair Display', serif", fontSize: 20, fontWeight: 700 }}>
                    {performingEntry.name}
                  </div>
                  <div style={{ color: "rgba(0,229,255,0.7)", fontFamily: "'Crimson Text', serif", fontStyle: "italic", fontSize: 15 }}>
                    {performingEntry.song}
                  </div>
                </div>
                <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
                  <input type="checkbox" onChange={() => markDone(performingEntry.id)}
                    style={{ width: 20, height: 20, cursor: "pointer", accentColor: "#00e5ff" }} />
                  <span style={{ color: "#00e5ff", fontFamily: "'Playfair Display', serif", fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase" }}>
                    Mark Done
                  </span>
                </label>
              </div>
            ...
            <div style={{
              background: "rgba(0,229,255,0.02)", border: "1px solid rgba(0,229,255,0.07)",
              borderRadius: 8, overflow: "hidden",
            }}>
              <div style={{
                padding: "14px 20px", borderBottom: "1px solid rgba(0,229,255,0.06)",
                ...
                {waitingQueue.map((entry, index) => (
                  <div key={entry.id} className="queue-row" style={{ animationDelay: `${index * 40}ms` }}>
                    <div style={{
                      ...
                      background: index === 0 ? "rgba(0,229,255,0.2)" : "rgba(255,255,255,0.05)",
                      border: `1px solid ${index === 0 ? "rgba(0,229,255,0.4)" : "rgba(255,255,255,0.1)"}`,
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontFamily: "'Playfair Display', serif",
                      color: index === 0 ? "#00e5ff" : "rgba(255,255,255,0.4)",
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ color: "rgba(0,229,255,0.6)", fontFamily: "'Crimson Text', serif", fontStyle: "italic", fontSize: 14, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                        {entry.song}
                      </div>
                    </div>
